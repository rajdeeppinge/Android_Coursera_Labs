...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Integer[] resId = new Integer[arrayList.size()];

		resId = (Integer[])arrayList.toArray(resId); //why (resId)
        
		// TODO: Start the DownloaderTask 
		download.execute(resId);
	...
	public class DownloaderTask extends AsyncTask<Integer[], Void, String[]> {
		...
		protected String[] doInBackground(Integer[]... params) {
			...
			//Generic parameter Integer[] in a varargs argument and the integer array passed by us
			// resId is always the first element in var args
			Integer[] resId = params[0];
